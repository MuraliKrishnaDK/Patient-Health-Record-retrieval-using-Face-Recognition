...
import argparse #recommended commandline parsing module
#from datetime import datetime
import hashlib #interface for hashinng messages easily
import os.path #merging, normalizing and retrieving path names
import random 
import re #regular expressions
import struct #convert native data types of python into string of bytes and wifies
import sys #functions and variables for manipulating parts of py runtime envi
import tarfile #compress grp of files into archives
